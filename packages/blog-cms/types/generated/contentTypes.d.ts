...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    author: Attribute.Relation<"api::article.article", "manyToOne", "api::writer.writer">;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiHomepageHomepage extends Schema.SingleType {
  ...
  attributes: {
    ...
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<"api::homepage.homepage", "oneToOne", "admin::user"> & Attribute.Private;
    updatedBy: Attribute.Relation<"api::homepage.homepage", "oneToOne", "admin::user"> & Attribute.Private;
  };
}
...
export interface ApiListingListing extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String & Attribute.Required;
    slug: Attribute.UID<"api::listing.listing", "title"> & Attribute.Required;
    createdAt: Attribute.DateTime;
    bathrooms: Attribute.Text & Attribute.Required;
    bedrooms: Attribute.Text & Attribute.Required;
    description: Attribute.Text & Attribute.Required;
    type: Attribute.Text & Attribute.Required;
    isFeatured: Attribute.Text & Attribute.Required;
    isRecommended: Attribute.Text & Attribute.Required;
    photos: Attribute.Text & Attribute.Required;
    capacity: Attribute.Text & Attribute.Required;
    ammenities: Attribute.Text & Attribute.Required;
    reviews_stars: Attribute.Text & Attribute.Required;
    reviews_number: Attribute.Text & Attribute.Required;
    isFavorited: Attribute.Text & Attribute.Required;
    address: Attribute.Text & Attribute.Required;
    fees: Attribute.Text & Attribute.Required;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<"api::listing.listing", "oneToOne", "admin::user"> & Attribute.Private;
    updatedBy: Attribute.Relation<"api::listing.listing", "oneToOne", "admin::user"> & Attribute.Private;
  };
}
...
export interface ApiWriterWriter extends Schema.CollectionType {
  ...
  attributes: {
    ...
    articles: Attribute.Relation<"api::writer.writer", "oneToMany", "api::article.article">;
